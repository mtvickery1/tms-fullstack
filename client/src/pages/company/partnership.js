            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <div className="row">
                  ...
                  <div className="col">
                    <p className="font-italic"><h2 className="timeline-title blue-text"><strong>Dell EMC</strong></h2></p>
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <div className="row">
                  ...
                  <div className="col">
                    <p className="font-italic"><h2 className="timeline-title blue-text"><strong>QHE Logistics</strong></h2></p>
                    <div className="timeline-body">
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <div className="row">
                  ...
                  <div className="col">
                    <p className="font-italic"><h2 className="timeline-title blue-text"><strong>Grupo Escalante</strong></h2></p>
                    <div className="timeline-body">
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <div className="row">
                  ...
                  <div className="col">
                    <p className="font-italic"><h2 className="timeline-title blue-text"><strong>PROVA Warehousing</strong></h2></p>
                    <div className="timeline-body">
                      <p className="font-italic"><h3><small>TMS and PROVA have partnered together to offer their clients more than 15,000 square meters of permanent/temporary warehousing at locations within Mexico City, Cancun, and Guadalajara. In conjunction with our warehousing capabilities, we can provide transportation and distribution centers throughout Mexico.</small></h3></p>
                      <br></br>
            ...
            <div className="timeline-panel">
              <div className="timeline-heading">
                <div className="row">
                  ...
                  <div className="col">
                    <p className="font-italic"><h2 className="timeline-title blue-text"><strong>GES Returns Mexico</strong></h2></p>
                    <div className="timeline-body">
